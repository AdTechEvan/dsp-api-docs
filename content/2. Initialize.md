> [!note] Be sure you have [[1. Install|installed]] the API before initialization.
# Signature
...
- **Arguments**
  ...
  - `opts` - _(optional)_ - JavaScript object with additional initialization options:
    - `frameSrc`
      - The location of the [[1. Install|DSP Iframe]]. It must exist within the `dspOrigin`.
...
See: [[3. Registering a Bidding Signal]]
